...
public:
    ...
    void setupUi(QDialog *OptionDialog)
    {
        ...
        label_16->setGeometry(QRect(260, 170, 16, 16));
        label_17 = new QLabel(OptionDialog);
        label_17->setObjectName(QStringLiteral("label_17"));
        label_17->setGeometry(QRect(160, 170, 16, 16));
        ...
        lineEditSilhouetteGreen->setGeometry(QRect(220, 170, 31, 20));
